...
public class StatisticsActivitySuperadmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statistics_superadmin);
    ...
    private void setupCharts() {
        if (pieChartUsers != null) setupUsersChart();
        if (barChartReservations != null) setupReservationsChart();
        if (pieChartLogs != null) setupLogsChart();
    }
