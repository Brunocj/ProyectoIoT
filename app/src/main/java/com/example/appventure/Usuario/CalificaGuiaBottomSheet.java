...
public class CalificaGuiaBottomSheet extends BottomSheetDialogFragment {
    public interface OnGuideReviewSubmitListener {
        void onGuideSubmitted(int rating, String comment);
    }

    private OnGuideReviewSubmitListener listener;
    private int rating = 0;

    public static CalificaGuiaBottomSheet newInstance() {
        return new CalificaGuiaBottomSheet();
    }

    public void setOnGuideReviewSubmitListener(OnGuideReviewSubmitListener l) {
        this.listener = l;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.bottomsheet_calificar_guia, container, false);
        ...
        btnGuardar.setOnClickListener(view -> {
            ...
            if (listener != null) listener.onGuideSubmitted(rating, comment);
            dismiss();
        });
